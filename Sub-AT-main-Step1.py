...
parser.add_argument('--save-dir', help='The directory used to save the trained models', default='results/CIFAR10/Sub-PGD/sub-at', type=str)
parser.add_argument('--log-dir', help='The directory used to save the log', default='results/CIFAR10/Sub-PGD/sub-at', type=str)
parser.add_argument('--log-name', dest='log_name', help='The log file name', default='Sub-AT.log', type=str)
...
def main():
    ...
    if args.pgd50:
        epoch_adversarial_PGD50(test_loader, model, attack_iters=50, restarts=1)
        epoch_adversarial_PGD50(test_loader, model, attack_iters=20, restarts=1)
        epoch_adversarial_PGD50(test_loader, model, attack_iters=10, restarts=1)
    if args.autoattack:
        AutoAttack(model, args, dataset=args.datasets)
