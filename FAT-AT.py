...
def main():
    ...
    logfile = os.path.join(args.out_dir, 'output_FAT.log')
    ...
    torch.save(best_state_dict, os.path.join(args.out_dir, 'model_FAT_Best.pth'))
    torch.save(model.state_dict(), os.path.join(args.out_dir, 'model_FAT_Final.pth'))
