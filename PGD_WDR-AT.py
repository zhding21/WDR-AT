...
def main():
    ...
    logfile = os.path.join(args.out_dir, 'output_PGD_Our.log')
    logging.basicConfig(
    ...
    def BO_train(alp, bet):
        ...
        torch.save(best_state_dict, f'{args.out_dir}/model_PGD_Best_our_{start_train_time}.pth')
        torch.save(model.state_dict(), f'{args.out_dir}/model_PGD_Final_our_{start_train_time}.pth')
