...
def main(model_val):
    ...
    logging.basicConfig(
        ...
        datefmt='%Y/%m/%d %H:%M:%S',
        level=logging.INFO,
        filename=os.path.join(output_path, 'output_FAT.log'))
    logger.info(args)
    ...
    def eval_model(alp, bet):
        ...
        # Evaluation
        model_test = MODEL[model_val](10).cuda().cuda()
...
if __name__ == "__main__":
    for model_val in ['LeNet', 'AlexNet', 'PreActResNet18', 'WideResNet34-10', 'DenseNet121']:
        main(model_val)
